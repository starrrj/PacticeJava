...
SELECT
    ...
    -- AM : 오전/오후, DY : 요일, HH(12시간제시간), HH24(24시간제 시간),
    -- MI : 2자리 분, SS: 2자리 초
...
SELECT
    ...
    -- "" : 한단어로 사용하지않고, 다국어,화이트스페이스,특수문자 입력시 
    -- 영어입력, 도트연산자 사용 시 "" 사용XX
FROM
    dual;
...
SELECT
    ...
    to_char(1234, 'B99999')   AS "B99999",   -- B: 공백을 0으로 표현, B라는건 앞의 공백을 말하는것!
...
-- SESSION : 현재! 디벨로퍼와 오라클서버간의 '연결'의 추상적의미
...
SELECT
    sysdate,
    -- sysdate - to_date('19930101', 'YYYYMMDD')
    current_date - to_date('19930101', 'YYYYMMDD')
FROM
    dual;
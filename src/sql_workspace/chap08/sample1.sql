...
--  (7) BLOB            - 대용량 이진데이터 저장 (최대 4GB)     -- 7,8,9번은 사용하지말자!
...
FROM
    dept
WHERE
    ROWID = 'AAASUgAAAAAACVLAAC'; -- ROWID 이용한 조건 검색

-- ------------------------------------------------------
--제약조건 생략시, default값 NULL제약조건이 들어간다.
...
VALUES (20, '박지성', 4000);    -- hiredate 컬럼제외
